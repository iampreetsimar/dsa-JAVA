...
public class dynamicStackImplement_2 {
    ...
    public static class CustomStack {
        ...
        // to make stack dynamic sized
        void push(int val) {
            if (tos == data.length - 1) {
                //System.out.println("Stack overflow");

                // initialize a new array of twice the size of data array
                ...
                // change data ref and point it to newData
                data = newData;

                // add the new element in updated array 
                // can directly call push(val) here
                tos++;
                data[tos] = val;
            } else {
                tos++;
