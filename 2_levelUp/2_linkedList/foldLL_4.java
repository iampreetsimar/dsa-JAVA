...
public class foldLL_4 {
    ...
    public static void foldList(ListNode node) {
        ...
        ListNode mid = getMidNode(node);    // returns mid node of list(2nd mid node in even sized list) ~ O(N)
        ...
        while(p2 != null) {     // second half list will be smaller(first half contains more nodes always) | T(N/2) ~ O(N)
